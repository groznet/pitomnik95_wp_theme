...
<div class="comment-respond-inner">
    ...
    <p>Используя форму, вы соглашаетесь с хранением ваших данных, вы можете связаться с нами напрямую сейчас</p>
    ...
    <form class="comment-form">
        <div class="form-inputs">
            <div class="row">
                ...
                <div class="col-lg-12 form-textarea">
                    <textarea id="comment" placeholder="Напишите ваше сообщение*"></textarea>
                </div>
        ...
        <div class="form-submit">
            <button class="ch-btn-style-2">Отправить</button>
        </div>
    </form>
</div>
